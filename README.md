...
<a href=https://www.datacamp.com//teach/repositories/119668363/go target="_blank"><img src="https://s3.amazonaws.com/assets.datacamp.com/img/github/content-engineering-repos/course_button.png" width="150"></a>
...
3. Check out your automatically updated <a href=https://www.datacamp.com/teach/repositories/119668363/go target="_blank">course on DataCamp</a>
...
Every DataCamp exercise consists of different parts, read up about them <a href=https://www.datacamp.com//teach/documentation#tab_code_exercises target="_blank">here</a>. A very important part about DataCamp exercises is to provide automated personalized feedback to students. In R, these so-called Submission Correctness Tests (SCTs) are written with the <a href=https://github.com/datacamp/testwhat target="_blank">`testwhat`</a> package. SCTs for SQL exercises are coded up with <a href=https://github.com/datacamp/sqlwhat target="_blank">`sqlwhat`</a>. Check out the GitHub repositories' wiki pages for more information and examples.
